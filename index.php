...
<html>
	...
	<body>
		<div id="container">
			<div id="header"></div>
			<div id="main">
				<a href="javascript:var%20criticalDomain='http://<?PHP echo($SITE_DOMAIN.$SITE_ROOT); ?>';var%20s=document.createElement('script');s.type='text/javascript';document.body.appendChild(s);s.src=criticalDomain+'/critical.min.js';void(0);">Drag me to your toolbar to Track the Truth</a>
				...
				<p>It also works elsewhere on the internet!  Check out <a href="http://kaystreet.wordpress.com/2010/11/27/">this article</a> and try running the bookmarklet again.</p>
			</div>
			<div id="footer"></div>
		</div>
	</body>
