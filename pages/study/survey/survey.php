	...
	<body>
		<form action="next" method="POST">
			...
			<ul>
				...
				<li>How positive was the article about <?php echo($_SESSION['previous_topic']);?>?</li>
				<li>
					<table>
						<tr><th></th><th>Not at all</th><th colspan="5"></th><th>A lot</th></tr>
						<tr>
				...
				<li><input type="text" name="article-positive-pct"></li>
				...
				<li>
					<table>
						<tr><th>Strongly in favor of Democrats</th><th colspan="7"></th><th>Strongly in favor of Republicans</th></tr>
						<tr>
