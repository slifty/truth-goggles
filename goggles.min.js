activate_truth_goggles = function($) {
	...
	progress_update = function() {
		...
		if(next_snippet == null) {
			...
			switch(current_mode) {
				case MODE_GOGGLES:
					$("." + CLASS_ANTISNIPPET).removeClass(CLASS_ANTISNIPPET);
					console.log("." + CLASS_ANTISNIPPET_PREFIX + snippet_index)
					$("." + CLASS_ANTISNIPPET_PREFIX + snippet_index).addClass(CLASS_ANTISNIPPET);
					break;
			}
		}
	}
