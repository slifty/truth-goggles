(function() {
	var API_URL = "http://critical.istheinternetabigtruck.com/api/factcheck.php";
	var CSS_URL = "http://critical.istheinternetabigtruck.com/styles/critical.min.css";
	...
	for(var x = 0; x < paragraphs.length ; ++x) {
		...
		var text = paragraphs[x].textContent?paragraphs[x].innerText:paragraphs[x].textContent;
